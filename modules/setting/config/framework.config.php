    ...
    'fields'      => array(
        ...
        array(
            ...
            array(
                ...
                'type'        => 'gallery',
                'title'       => '头部背景图',
                'desc'        => '尺寸 1920*1080，建议压缩，多张不会轮播，刷新时随机切换',
                'add_title'   => '添加图像',
                'edit_title'  => '修改图像',
                'clear_title' => '清除图像',
            ),
...
$options[]      = array(
    ...
    'fields'      => array(
		...
		array(
            ...
            'type'   => 'textarea',
            'before' => '<h4>统计代码</h4>',
            'after'  => '<p class="cs-text-muted">无需写入<strong>&lt;script></strong>标签，默认隐藏，如需添加入口以下填写。',
		),
...
$options[]   = array(
    ...
    'fields' => array(
        ...
        array(
            'type'    => 'notice',
            'class'   => 'warning',
            'content' => '考虑到盗版因素，在没有好的方案之前，暂不支持',
        ),
